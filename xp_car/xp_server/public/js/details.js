        ...
        $.ajax({//向服务器发送请求
            ...
            success: function(result){//得到
                ...
                for(var spec of specs){
                    ...
                    btn-outline-secondary ${spec.lid==lid?
                    'active':''}"
                    href="product_details.html?lid=
                    ${spec.lid}">${spec.spec}</a>`
                }
                //将HTML放入对应div中
                ...
                var $divLg=$("#div-lg")
                .css({backgroundImage:`url(${pics[0].lg})`});
                //2.点击左右按钮，让ul左右移动
                //查找两个按钮:
                ...
                $btnRight.click(function(){
                    ...
                    moved++;//左移的次数+1
                    //设置ul的margin-left永远等于li的宽-62*moved
