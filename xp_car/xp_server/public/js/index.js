(function(){
    ...
    $.ajax({
      ...
      .then(function(result){
        ...
        var div1=document.querySelector("#main>div:nth-child(2)>h3:first-child>div:nth-child(2)>div:first-child")
        div1.innerHTML=html;
        ...
        <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="${p2.pic}" data-holder-rendered="true"></div>`
    ...
    // var div3=document.querySelector("#main>div:nth-child(2)>h3:first-child>div:nth-child(3)>div:first-child");
